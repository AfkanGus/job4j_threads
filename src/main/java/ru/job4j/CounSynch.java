 ...
 */
public class CounSynch {
    /*не явный манитор, когда манитором будет сам объект класса - CountSynch*/
    private int valueS;
     ...
     *При заходе нити в syncronized метод класса, другая нить
     * зайдет в метод после того как первая нить его освободит*/
